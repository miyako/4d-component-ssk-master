...
TRUNCATE TABLE:C1051([診療行為:5])
SET DATABASE PARAMETER:C642([診療行為:5]; Table sequence number:K37:31; 0)
...
$names:=New collection:C1472("s@"; "医科診療行為@")
...
rezept-master-01.csv
		
*/
		
		$valuesFolder:=Folder:C1567("/DATA/")
		$files:=$valuesFolder.files()
		$names:=New collection:C1472("rezept-master-01")  //労災診療行為

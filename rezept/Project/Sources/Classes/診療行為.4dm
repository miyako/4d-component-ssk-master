...
Function _createRecords($CLI : cs:C1710.CLI; $values : Collection)
	...
	$e["項目"]["データ規格名"]:=New object:C1471
	$e["項目"]["データ規格名"]["漢字有効桁数"]:=$values[8]
	$e["項目"]["データ規格名"]["漢字名称"]:=$values[9]
	$e["新又は現点数"]:=New object:C1471
	...
	$e["項目"]["コード表用番号(アルファベット部を除く)"]:=New object:C1471
	...
	$e["項目"]["告示・通知関連番号(アルファベット部を除く)"]:=New object:C1471
